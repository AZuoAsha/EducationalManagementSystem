    ...
    <div class="banner">
        <div class="bgh">
            <div class="page">
                ...
                <div class="topxx">
                    <select onchange="changeCateory($(this))" style="font-size: 12px; background: #fff;color: #ccc;border:#fff">
                        ...
                        <option selected='selected'
                            value="1">
                            <%=student.getBaokaoLeibie() %></option>
...
<div class="cztable">
    <table border="0" cellspacing="0" cellpadding="0" width="100%" style="font-size:12px">
        <tr>
            ...
            <td colspan="5"><%=student.getStudent_class_name() %>&nbsp;</td>
        </tr>
        <tr>
            <td width="91" align="right">班级号：</td>
            <td colspan="5"><%=student.getStudent_class() %>&nbsp;</td>
        </tr>
        <tr>
            <td align="right">班级QQ群：</td>
            <td colspan="5"><%=student.getBanjiQq() %> &nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="5"><%=student.getStudent_college() %>&nbsp;</td>
        </tr>
            
            <tr>
                    <td align="right"><div align="right">辅导员老师：</div>&nbsp;</td>
                    <td><div align="left"><%=student.getTeacher() %></div></td>
                    <td><div align="right">电话：</div>&nbsp;</td>
                    <td><div align="left"><%=student.getTeacherPhone() %></div>&nbsp;</td>
                    <td align="right"><div align="right">在线交流：</div>&nbsp;</td>
                    <td align="right"><div align="left"><a target="_blank" href="user/studentinfor/letter.aspx.jsp"><img border="0" src="images/student/default/bt_bzr.jpg" alt="点击这里给我发消息" /></a></div>&nbsp;</td>
                  </tr>
