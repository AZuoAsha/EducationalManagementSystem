...
<title>
    ...
    <script src="../script/Data.js" type="text/javascript"></script>
     ...
     <%List<MyObjection> mList=(List<MyObjection>)session.getAttribute("myObjection"); %>
        ...
        <div class="bgh">
            <div class="page">
                ...
                <div class="topxx">
                    ...
                    <%=student.getStudent_id() %>学员：<%=student.getStudent_name() %>，欢迎您！ <a href="index.aspx.jsp">我的信息</a> <a href="../user/studentinfor/systemmsge.aspx.jsp">
        ...
        <div class="box mtop">
            <div class="leftbox">
                <div class="l_nav2">
                    ...
                    <div class="cdlist">
                        <div>
                            <a href="index.aspx.jsp">我的信息</a></div>
                        <div>
                            <a href="classinfo.aspx.jsp">班级信息 </a>
                        </div>
                        <div>
                        ...
                        <div>
                            <a href="objection.aspx.jsp">我的异议</a></div>
                    </div>
                    <div class="ta1">
                        <strong>教务中心</strong>
                        <div class="leftbgbt2">
...
<ul id="ulStudMsgHeadTab">
    <li><a class="tab2" onclick="" href="index.aspx.jsp">个人资料</a> </li>
    <li><a class="tab2" onclick="" href="classinfo.aspx.jsp">班级信息</a></li>
    <li><a class="tab2" onclick="" href="../user/studentinfor/letter.aspx.jsp">短信息</a></li>
...
<div class="cztable">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr style="height: 28px;color:red" class="tdbg" align="center">
            ...
            <td width="5%"><%=i+1 %></td>
            <td width="10%"><%=mList.get(i).getObjectionType() %></td>
            <td width="15%"><%=mList.get(i).getMtitle() %></td>
            <td width="20%"><%=mList.get(i).getObjectionContext() %></td>
             <%SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
                    String dateString = formatter.format(mList.get(i).getCreateTime()); %>
            <td width="18%"><%=dateString %></td>
            <td width="13%"><%=mList.get(i).getStatus() %></td>
